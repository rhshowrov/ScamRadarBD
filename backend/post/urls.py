...
from .views import PlaceViewSet,dataAnalysis,PostListView,getVoteCount, \
    postImageList,likeDislike,CommentListCreateByPost,SearchListView, \
        PostListByQuery,ToggleBookmark,SinglePostRetriveView

urlpatterns = [
    path('create_post/',create_post,name='create_post'),
    path('getplace/',PlaceViewSet.as_view({'get': 'list', 'post': 'create'}),name='get_place'),
    path('get_posts/',PostListView,name='get_post'),
    path('get_post/<int:pk>',SinglePostRetriveView.as_view(),name='get_single_post'),
